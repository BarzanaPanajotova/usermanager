sap.ui.define([
	...
	return BaseController.extend("sap.ui.demo.nav.controller.user.overview.UserOverview", {

		onInit: function () {
			var oRouter = this.getRouter();

			this._oTable = this.byId("usersTable");
			this._oVSD = null;
			this._sSortField = null;
			this._bSortDescending = false;
			this._aValidSortFields = ["UserID", "FirstName", "LastName"];
			...
			oRouter.getRoute("userOverview").attachMatched(this._onRouteMatched, this);
		...
		onAddRowPressed : function(oArg){
			var oNewObject = {UserID:"",FirstName:"",LastName:"",Address:"",City:"",Region:"",PostalCode:"",Country:"",HomePhone:""	};
			this.jModel.push(oNewObject);
			this.jModel.refresh();//which will add the new record
		},
		onSortButtonPressed : function (oEvent) {
			var oRouter = this.getRouter();
			this._oRouterArgs.query.showDialog = 1;
			oRouter.navTo("userOverview",this._oRouterArgs);
		},

		onSearchUsersTable : function (oEvent) {
			var oRouter = this.getRouter();
			// update the hash with the current search term
			this._oRouterArgs.query.search = oEvent.getSource().getValue();
			oRouter.navTo("userOverview",this._oRouterArgs, true /*no history*/);
		},
		...
		_initViewSettingsDialog : function () {
			...
			this._oVSD = new sap.m.ViewSettingsDialog("vsd", {
				confirm: function (oEvent) {
					...
					oRouter.navTo("userOverview",this._oRouterArgs, true /*without history*/);
				}.bind(this),
			...
			this._oVSD.addSortItem(new sap.m.ViewSettingsItem({
				key: "UserID",
				text: "User ID",
				selected: true			// by default the MockData is sorted by UserID
			}));
		...
		_syncViewSettingsDialogSorter : function (sSortField, bSortDescending) {
			// the possible keys are: "UserID" | "FirstName" | "LastName"
